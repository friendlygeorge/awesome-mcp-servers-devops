...
| **Note** | 🔨 Agent-native design — built for autonomous infrastructure management. MIT license. |
...
| [friendlygeorge/system-monitoring-mcp-server](https://github.com/friendlygeorge/system-monitoring-mcp-server) | 💻 19 tools for host-level Linux monitoring — CPU, memory, disk, network, processes, systemd, logs. Agent-native. |
